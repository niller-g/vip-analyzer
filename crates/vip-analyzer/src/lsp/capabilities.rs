...
use lsp_types::{
    ...
    CompletionOptionsCompletionItem, DeclarationCapability, OneOf, PositionEncodingKind,
    SaveOptions, ServerCapabilities, TextDocumentSyncCapability, TextDocumentSyncKind,
    TextDocumentSyncOptions, WorkDoneProgressOptions, WorkspaceFileOperationsServerCapabilities,
    WorkspaceFoldersServerCapabilities, WorkspaceServerCapabilities,
};

use crate::{config::Config, line_index::PositionEncoding, lsp::ext};
...
pub fn server_capabilities(config: &Config) -> ServerCapabilities {
    ServerCapabilities {
        ...
        references_provider: if cfg!(debug_assertions) { Some(OneOf::Left(true)) } else { None }, // TODO: <-- Still under development
        ...
        diagnostic_provider: Some(lsp_types::DiagnosticServerCapabilities::Options(
            lsp_types::DiagnosticOptions {
                identifier: Some("vip-analyzer".to_owned()),
