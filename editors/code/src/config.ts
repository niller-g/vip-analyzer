...
export class Config {
    readonly extensionId = "niller-g.vip-analyzer";
    configureLang: vscode.Disposable | undefined;

    readonly rootSection = "vip-analyzer";
    ...
    private async onDidChangeConfiguration(event: vscode.ConfigurationChangeEvent) {
        ...
        if (userResponse) {
            const command = "vip-analyzer.restartServer";
    ...
    private configureLanguage() {
        ...
        //     ];
        // }
        // this.configureLang = vscode.languages.setLanguageConfiguration("vip", {
        //     onEnterRules,
        // });
    }
