...
export class VipLanguageClient extends lc.LanguageClient {
    override handleFailedRequest<T>(
        ...
        if (
            ...
            // Don't show notification for internal errors, these are emitted by v-a when a request fails.
